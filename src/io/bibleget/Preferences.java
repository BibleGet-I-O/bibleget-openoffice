...
public class Preferences {
    ...
    public BGET.PREFERORIGIN PREFERREDORIGIN;
    ...
    private void getStringOption(String key, String value) {
        switch (key) {
            case "PARAGRAPHSTYLES_FONTFAMILY":
                PARAGRAPHSTYLES_FONTFAMILY = value;
                break;
            case "BIBLEVERSIONSTYLES_TEXTCOLOR":
                BIBLEVERSIONSTYLES_TEXTCOLOR = Color.decode(value);
                break; //will need to decode string representation of hex value with Color.decode(BGET.BIBLEVERSIONSTYLES_TEXTCOLOR)
            case "BIBLEVERSIONSTYLES_BGCOLOR":
                BIBLEVERSIONSTYLES_BGCOLOR = Color.decode(value);
                break; //decode string representation of hex value
            case "BOOKCHAPTERSTYLES_TEXTCOLOR":
                BOOKCHAPTERSTYLES_TEXTCOLOR = Color.decode(value);
                break; //decode string representation of hex value
            case "BOOKCHAPTERSTYLES_BGCOLOR":
                BOOKCHAPTERSTYLES_BGCOLOR = Color.decode(value);
                break; //decode string representation of hex value
            case "VERSENUMBERSTYLES_TEXTCOLOR":
                VERSENUMBERSTYLES_TEXTCOLOR = Color.decode(value);
                break;
            case "VERSENUMBERSTYLES_BGCOLOR":
                VERSENUMBERSTYLES_BGCOLOR = Color.decode(value);
                break; //decode string representation of hex value
            case "VERSETEXTSTYLES_TEXTCOLOR":
                VERSETEXTSTYLES_TEXTCOLOR = Color.decode(value);
                break; //decode string representation of hex value
            case "VERSETEXTSTYLES_BGCOLOR":
                VERSETEXTSTYLES_BGCOLOR = Color.decode(value);
                break;
    ...
    private void getNumberOption(String key, int value) {
        switch (key) {
            case "PARAGRAPHSTYLES_LINEHEIGHT":
                PARAGRAPHSTYLES_LINEHEIGHT = value;
                break; //think of it as percent
            case "PARAGRAPHSTYLES_ALIGNMENT":
                PARAGRAPHSTYLES_ALIGNMENT = BGET.ALIGN.valueOf(value);
                break;
            case "PARAGRAPHSTYLES_MEASUREUNIT":
                PARAGRAPHSTYLES_MEASUREUNIT = BGET.MEASUREUNIT.valueOf(value);
                break;
            case "BIBLEVERSIONSTYLES_FONTSIZE":
                BIBLEVERSIONSTYLES_FONTSIZE = value;
                break;
            case "BIBLEVERSIONSTYLES_VALIGN":
                BIBLEVERSIONSTYLES_VALIGN = BGET.VALIGN.valueOf(value);
                break;
            case "BOOKCHAPTERSTYLES_FONTSIZE":
                BOOKCHAPTERSTYLES_FONTSIZE = value;
                break;
            case "BOOKCHAPTERSTYLES_VALIGN":
                BOOKCHAPTERSTYLES_VALIGN = BGET.VALIGN.valueOf(value);
                break;
            case "VERSENUMBERSTYLES_FONTSIZE":
                VERSENUMBERSTYLES_FONTSIZE = value;
                break;
            case "VERSENUMBERSTYLES_VALIGN":
                VERSENUMBERSTYLES_VALIGN = BGET.VALIGN.valueOf(value);
                break;
            case "VERSETEXTSTYLES_FONTSIZE":
                VERSETEXTSTYLES_FONTSIZE = value;
                break;
            case "VERSETEXTSTYLES_VALIGN":
                VERSETEXTSTYLES_VALIGN = BGET.VALIGN.valueOf(value);
                break;
            case "LAYOUTPREFS_BIBLEVERSION_SHOW":
                LAYOUTPREFS_BIBLEVERSION_SHOW = BGET.VISIBILITY.valueOf(value);
                break;
            case "LAYOUTPREFS_BIBLEVERSION_ALIGNMENT":
                LAYOUTPREFS_BIBLEVERSION_ALIGNMENT = BGET.ALIGN.valueOf(value);
                break;
            case "LAYOUTPREFS_BIBLEVERSION_POSITION":
                LAYOUTPREFS_BIBLEVERSION_POSITION = BGET.POS.valueOf(value);
                break;
            case "LAYOUTPREFS_BIBLEVERSION_WRAP":
                LAYOUTPREFS_BIBLEVERSION_WRAP = BGET.WRAP.valueOf(value);
                break;
            case "LAYOUTPREFS_BOOKCHAPTER_ALIGNMENT":
                LAYOUTPREFS_BOOKCHAPTER_ALIGNMENT = BGET.ALIGN.valueOf(value);
                break;
            case "LAYOUTPREFS_BOOKCHAPTER_POSITION":
                LAYOUTPREFS_BOOKCHAPTER_POSITION = BGET.POS.valueOf(value);
                break;
            case "LAYOUTPREFS_BOOKCHAPTER_WRAP":
                LAYOUTPREFS_BOOKCHAPTER_WRAP = BGET.WRAP.valueOf(value);
                break;
            case "LAYOUTPREFS_BOOKCHAPTER_FORMAT":
                LAYOUTPREFS_BOOKCHAPTER_FORMAT = BGET.FORMAT.valueOf(value);
                break;
            case "LAYOUTPREFS_VERSENUMBER_SHOW":
                LAYOUTPREFS_VERSENUMBER_SHOW = BGET.VISIBILITY.valueOf(value);
                break;
            case "PREFERREDORIGIN":
                PREFERREDORIGIN = BGET.PREFERORIGIN.valueOf(value);
                break;
        }
    }
    ...
    private void getNumberOption(String key, Double value) {
        switch (key) {
            case "PARAGRAPHSTYLES_LEFTINDENT":
                PARAGRAPHSTYLES_LEFTINDENT = value;
                break;
            case "PARAGRAPHSTYLES_RIGHTINDENT":
                PARAGRAPHSTYLES_RIGHTINDENT = value;
                break;
        }
    }
    ...
    private void getBooleanOption(String key, boolean value) {
        switch (key) {
            case "PARAGRAPHSTYLES_NOVERSIONFORMATTING":
                PARAGRAPHSTYLES_NOVERSIONFORMATTING = value;
                break;
            case "BIBLEVERSIONSTYLES_BOLD":
                BIBLEVERSIONSTYLES_BOLD = value;
                break;
            case "BIBLEVERSIONSTYLES_ITALIC":
                BIBLEVERSIONSTYLES_ITALIC = value;
                break;
            case "BIBLEVERSIONSTYLES_UNDERLINE":
                BIBLEVERSIONSTYLES_UNDERLINE = value;
                break;
            case "BIBLEVERSIONSTYLES_STRIKETHROUGH":
                BIBLEVERSIONSTYLES_STRIKETHROUGH = value;
                break;
            case "BOOKCHAPTERSTYLES_BOLD":
                BOOKCHAPTERSTYLES_BOLD = value;
                break;
            case "BOOKCHAPTERSTYLES_ITALIC":
                BOOKCHAPTERSTYLES_ITALIC = value;
                break;
            case "BOOKCHAPTERSTYLES_UNDERLINE":
                BOOKCHAPTERSTYLES_UNDERLINE = value;
                break;
            case "BOOKCHAPTERSTYLES_STRIKETHROUGH":
                BOOKCHAPTERSTYLES_STRIKETHROUGH = value;
                break;
            case "VERSENUMBERSTYLES_BOLD":
                VERSENUMBERSTYLES_BOLD = value;
                break;
            case "VERSENUMBERSTYLES_ITALIC":
                VERSENUMBERSTYLES_ITALIC = value;
                break;
            case "VERSENUMBERSTYLES_UNDERLINE":
                VERSENUMBERSTYLES_UNDERLINE = value;
                break;
            case "VERSENUMBERSTYLES_STRIKETHROUGH":
                VERSENUMBERSTYLES_STRIKETHROUGH = value;
                break;
            case "VERSETEXTSTYLES_BOLD":
                VERSETEXTSTYLES_BOLD = value;
                break;
            case "VERSETEXTSTYLES_ITALIC":
                VERSETEXTSTYLES_ITALIC = value;
                break;
            case "VERSETEXTSTYLES_UNDERLINE":
                VERSETEXTSTYLES_UNDERLINE = value;
                break;
            case "VERSETEXTSTYLES_STRIKETHROUGH":
                VERSETEXTSTYLES_STRIKETHROUGH = value;
                break;
            case "LAYOUTPREFS_BOOKCHAPTER_FULLQUERY":
                LAYOUTPREFS_BOOKCHAPTER_FULLQUERY = value;
                break;
        }
    }
    //other methods here...
