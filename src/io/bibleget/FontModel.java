...
public class FontModel {
   ...
   */
  @SuppressWarnings(value = "unchecked")
  protected final void setAttributes(Map<TextAttribute, Object> attributes) {
      ...
      if (value != null) {
        ...
        if (valueName == null) {
          if (value instanceof Color) {
            ...
            sb.append("new Color(").append(color.getRed()).append(", ").append(color.getGreen()).append(", ").append(color.getBlue()).append(")");
          } else {
